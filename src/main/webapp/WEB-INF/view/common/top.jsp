        ...
        <c:choose>
	        ...
	        <c:otherwise>
		        <li class="dropdown" id="clsdropDwon">
		          <a href="#" class="dropdown-toggle clsdropDwon" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> ${sessionScope.SESSION_USER_KEY.username}<span class="caret"></span></a>
